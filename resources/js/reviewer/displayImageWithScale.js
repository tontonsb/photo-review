 ...
 */
export default function displayImage(target, center, extent, url, interactive = true, legacyScale = true) {
    ...
    const scale = legacyScale ? getPointResolution(viewWithoutExtent.getProjection(), 1, center) : 0.83236
